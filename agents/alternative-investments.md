...
description: Alternative investments specialist — REITs, InvITs, fractional real estate, commodities, crypto allocation, art, wine, collectibles. Non-traditional asset classes for portfolio diversification.
model: sonnet
tools: Read, Bash
maxTurns: 20
memory: project
