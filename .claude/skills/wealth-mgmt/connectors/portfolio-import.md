...
```bash
bash ${CLAUDE_SKILL_DIR}/../bin/import-portfolio.sh --format csv "<file-path>"
```

### 2. JSON Import
Direct import if already in standard schema:
```bash
bash ${CLAUDE_SKILL_DIR}/../bin/import-portfolio.sh --format json "<file-path>"
```
...
```bash
bash ${CLAUDE_SKILL_DIR}/../bin/import-portfolio.sh --format zerodha "<file-path>"
```
...
```bash
bash ${CLAUDE_SKILL_DIR}/../bin/import-portfolio.sh --format groww "<file-path>"
```
...
```bash
bash ${CLAUDE_SKILL_DIR}/../bin/import-portfolio.sh --format cams "<file-path>"
```
