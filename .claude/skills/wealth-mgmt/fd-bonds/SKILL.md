...
version: 1.0.0
description: |
  Fixed deposit and bond analysis for Indian investors. Compare FD rates across
  banks, evaluate corporate bonds and NCDs, Sovereign Gold Bond tracking, tax-free
  bonds, government securities (G-Sec/SDL), and debt ladder construction.
  Use when asked to "compare FD rates", "bond analysis", "NCD", "SGB",
  "tax-free bonds", "fixed income", or "debt allocation".
allowed-tools:
  - Bash
  - Read
  - Write
...
```bash
bash ${CLAUDE_SKILL_DIR}/../bin/fd-compare.sh --tenure <years>
```
