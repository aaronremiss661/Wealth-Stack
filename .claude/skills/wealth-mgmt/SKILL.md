...
version: 1.0.0
description: |
  Wealth management plugin for Claude Code. Provides portfolio analysis, risk
  assessment, tax optimization, rebalancing, client reporting, market research,
  compliance checking, and financial planning. Invoke with /wealth-mgmt to see
  all available commands and capabilities.
allowed-tools:
  - Bash
  - Read
  - Write
...
bash ${CLAUDE_SKILL_DIR}/bin/wealth-config.sh set api_key "YOUR_KEY"

# Set default benchmark
bash ${CLAUDE_SKILL_DIR}/bin/wealth-config.sh set benchmark "SPY"

# Set default currency
bash ${CLAUDE_SKILL_DIR}/bin/wealth-config.sh set currency "USD"
```
