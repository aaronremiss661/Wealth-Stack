...
version: 1.0.0
description: |
  Dedicated retirement calculator for Indian investors. FIRE number computation,
  Monte Carlo simulation, 4% rule (adjusted for India), NPS optimization,
  EPF/PPF integration, systematic withdrawal plan (SWP), and retirement
  income ladder. Use when asked to "retirement calculator", "can I retire",
  "FIRE number", "how much do I need to retire", "early retirement",
  "NPS planning", or "retirement income".
allowed-tools:
  - Bash
  - Read
  - Write
