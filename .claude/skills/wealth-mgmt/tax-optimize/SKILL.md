...
version: 1.0.0
description: |
  Tax optimization for investment portfolios. Tax-loss harvesting identification,
  capital gains management, wash sale detection, lot-level optimization, and
  tax-efficient withdrawal sequencing.
  Use when asked to "optimize taxes", "tax-loss harvest", "capital gains",
  or "tax strategy".
allowed-tools:
  - Bash
  - Read
...
Gather tax context via AskUserQuestion:
...
Invoke the **Tax Strategist** subagent via Agent tool:
