...
version: 1.0.0
description: |
  Indian stock screener. Screen NSE/BSE stocks by fundamentals (PE, ROE, ROCE,
  debt-to-equity), technicals (52-week high/low, moving averages), dividends,
  and sector. Quality filters inspired by Marcellus Coffee Can approach.
  Use when asked to "screen stocks", "find stocks", "stock screener",
  "quality stocks", "undervalued stocks", or "dividend stocks".
allowed-tools:
  - Bash
  - Read
  - Write
...
```bash
bash ${CLAUDE_SKILL_DIR}/../bin/nse-screener.sh --screen "<screen_type>" --limit 20
```
